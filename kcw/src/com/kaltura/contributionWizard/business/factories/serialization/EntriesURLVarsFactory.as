...
package com.kaltura.contributionWizard.business.factories.serialization
{
	...
	/**
	 * This factory class creates the suitable url vars for eacn import VO.
	 * @author Michal
	 * 
	 */	
	...
	{
		/**
		 * This function returns the urlVars that suits the given context & import Vo's array.  
		 * @param context the context of the request
		 * @param importVOs the import vo's that their values should be addedto the urlvars.
		 * @return the urlVars that suites the given import vo's
		 * 
		 */		
		...
		/**
		 * Add urlVars according to the suitable object type 
		 * @param valueObject the object that requires the url vars

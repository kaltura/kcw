...
package com.kaltura.contributionWizard.business.factories
{
	...
	/**
	 * This class factory returns the suitable inportUrlVo according to given XML 
	 * @author Michal
	 * 
	 */	
	...
	{
		/**
		 * This function returns an array of importUrlVo's that represents the given XMLList 
		 * @param xmllSearchResults the given XMLList
		 * @return the suitable array of importUrlVo's
		 * 
		 */	
		...
		/**
		 * This function builds the suitable importUrlVo according to the given XML 
		 * @param xmlSearchResult the given XML
		 * @param importUrlVo the instance of the importUrlVo to work on
		 * @return the importUrlVo after all changes were applied on it
		 * 
		 */		

...
package com.kaltura.controls.kobjecthadles.cursors
{
	...
	public class NESWCursor extends Sprite
	{
		[Embed(source="../assets/cursors/light/SizeNESW.png")] [Bindable] public var CursorNESWCls:Class;
		
		private var rottationEffect : Rotate;
		
		public function NESWCursor()
		{
			super();		
			var bitmapAsset : BitmapAsset = new CursorNESWCls();
